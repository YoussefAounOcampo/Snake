...
namespace Snake
{
    ...
    public class GameState
    {
        ...
        private IEnumerable<Position> EmptyPositions()
        {
            for (int r = 0; r < Rows; r++)
            {
                for (int c = 0; c < Cols; c++)
                {
                    ...
                    {
                        // Encontramos una posición vacía en la cuadrícula
                        // En lugar de devolverla inmediatamente, utilizamos "yield return"
                        // para devolverla uno a uno a medida que se encuentran.
        ...
        private Direction GetLastDirecction()
        {
        ...
        private bool CanChangeDirection(Direction newDir)
        {
            ...
            Direction lastDir = GetLastDirecction();
